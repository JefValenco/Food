...
- **Search By 'ID':** _"https://api.spoonacular.com/recipes/${id}/information"_
  https://api.spoonacular.com/recipes/${id}/information?api_Key=${API_KEY1}
  https://api.spoonacular.com/recipes/${id}/information?api_Key=548222ed87bd4ab18f3e419f3db8e9d7&addRecipeInformation=true

  https://api.spoonacular.com/recipes/${id}/information?${API_KEY1} // de él

  https://api.spoonacular.com/recipes/${id}/information?apiKey=548222ed87bd4ab18f3e419f3db8e9d7

  https://api.spoonacular.com/recipes/3/information?apiKey=${API_KEY1}
  https://api.spoonacular.com/recipes/3/information?api_Key=548222ed87bd4ab18f3e419f3db8e9d7
  <br />
