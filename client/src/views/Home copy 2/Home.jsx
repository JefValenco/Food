...
const Home = () => {
  ...
  useEffect(() => {
    ...
    // Update state when the media query condition changes
    const handleMediaQueryChange = (e) => {
      setIsSmallScreen(e.matches);
    };

    // Add event listener to track media query changes
    ...
    <div>
          ...
          <div className={style.links3}>
            {showMenu ? (
              <div className={style.links2}>
                ...
                >
                  <li className={style.navMobile}>
                    <a onClick={handleXClick}>x</a>
                  </li>
                  <li>
                    {" "}
                  ...
                  <li className={style.navMobile}>
                    <a href="#recipeSection">Recipes</a>
                  </li>
                  <li>
                    {" "}
                    <div className={style.divider}></div>
                  ...
                  <li className={style.navMobile}>
                    <a href="#createSection">Create Recipe</a>
                  </li>
                  <li>
                    {" "}
                    <div className={style.divider}></div>
                  ...
                  <li className={style.navMobile}>
                    <a href="#modifySection">Modify Recipe</a>
                  </li>
                  <li>
                    {" "}
                    <div className={style.divider}></div>
      ...
      <div className={styles.container0}>
        ...
        >
          ...
          <div className={styles.imageWrapper}>
            <img src={lettuce} alt="lettuce" className={styles.image} />
          </div>
          <div
            className={styles.comment}
            style={{
      ...
      {/*    <div>
        ...
        <div className={styles.c} style={{ position: "relative"}}>
        <div className={styles.d} > <div  className={styles.e} style={{ position: "absolute",  zIndex: 1,}}></div></div>
